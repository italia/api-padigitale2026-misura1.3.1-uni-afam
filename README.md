...
**2** -  **Pubblicazione degli e-service su PDND**</br> Si ricorda che in fase di pubblicazione degli e-service sulla piattaforma PDND, il nome deve rispettare quello nella colonna denominata "Nome" della tabella 1, ossia il seguente pattern e comunque seguire la [guida alla pubblicazione degli e-service](doc/06_deployment/Guida_erogazione_e-service_Università_e_AFAM.pdf)
